...
namespace GCUBankModel
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            FundsTransferTransaction ftt1 = new FundsTransferTransaction("T001", DateTime.Now, 500.00m, "99-99-00", "990011");
            FundsTransferTransaction ftt2 = new FundsTransferTransaction("T002", DateTime.Now, 200.00m, "44-44-00", "440011");
            WithdrawalTransaction wdt1 = new WithdrawalTransaction("T003", DateTime.Now, 200.00m, "88-88-00");
            WithdrawalTransaction wdt2 = new WithdrawalTransaction("T004", DateTime.Now, 75.00m, "88-88-01");
            CreditTransaction crt1 = new CreditTransaction("T005", DateTime.Now, 600.00m, "88-88-02");
          ...
          //  Console.WriteLine("before Added Interest - SavingsAccount Balance={0:c}", sacc.GetBalance());
            sacc.AddInterest();
